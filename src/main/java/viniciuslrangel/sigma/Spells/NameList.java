 ...
 * File Created @ [16/02/2016, 21:35 (UTC-3)]
 */
...
public class NameList {
    ...
    //Groups
    public static final String GROUP_ADVANCED_FLOWCONTROL = "advancedFlowControl";
    public static final String GROUP_BOOLEAN = "booleanSystem";
    public static final String GROUP_VARIABLES = "variableSystem";
